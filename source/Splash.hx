...
class Splash extends FlxSprite {
    ...
    public function new(?note:Note, ?debug = false) {
        ...
        // this sprite was only used as a placeholder because week7 assets where banned on gamebanana at the time of coding this engine

		frames = Paths.getSparrowAtlas('noteSplashs');
        if (note != null) {
			switch (note.noteData) {
				case 0:
					animation.addByPrefix('splash', 'purple splash', 20, false);
				case 1:
					animation.addByPrefix('splash', 'blue splash', 20, false);
				case 2:
					animation.addByPrefix('splash', 'green splash', 20, false);
				case 3:
					animation.addByPrefix('splash', 'red splash', 20, false);
			}
        }
        */
