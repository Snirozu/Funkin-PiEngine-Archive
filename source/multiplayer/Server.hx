		...
		try {
			...
			if (strMsg.contains("::")) {
				...
				switch (msgSplitted[0]) {
					...
					case "NP":
						PlayState.instance.multiplayerNoteHit(new Note( splited1, CoolUtil.stringToOgType(msgSplitted[2]) ), true);
					case "SNP":
						PlayState.instance.strumPlayAnim(splited1, "dad", "pressed");
					case "SNR":
						PlayState.instance.strumPlayAnim(splited1, "dad", "static");
					case "SCO":
